...
parser.add_argument("-fqdn", "--rangerURL", dest = "fqdn", help="Ranger FQDN, e.g. https://<Ranger FQDN>")
...
for url, label in zip(list_of_urls, url_label):
	web_url = ranger_server_url + "/v3/settings/" + url
