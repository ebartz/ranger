...
def test_rke_custom_k8s_1_8_10():
    validate_k8s_version("v1.8.10-ranger1-1", plugin=NETWORK_PLUGIN)


def test_rke_custom_k8s_1_8_11():
    validate_k8s_version("v1.8.11-ranger1", plugin=NETWORK_PLUGIN)


def test_rke_custom_k8s_1_9_5():
    validate_k8s_version("v1.9.5-ranger1-1", plugin=NETWORK_PLUGIN)


def test_rke_custom_k8s_1_9_7():
    validate_k8s_version("v1.9.7-ranger1", plugin=NETWORK_PLUGIN)


def test_rke_custom_k8s_1_10_0():
    validate_k8s_version("v1.10.0-ranger1-1", plugin=NETWORK_PLUGIN)


def test_rke_custom_k8s_1_10_1():
    validate_k8s_version("v1.10.1-ranger1", plugin=NETWORK_PLUGIN)
