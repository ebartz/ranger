...
import (
	...
	ekscattleiov1 "github.com/ranger/eks-operator/pkg/apis/eks.cattle.io/v1"
	v1alpha1 "github.com/ranger/fleet/pkg/apis/fleet.cattle.io/v1alpha1"
	gkecattleiov1 "github.com/ranger/gke-operator/pkg/apis/gke.cattle.io/v1"
	projectcattleiov3 "github.com/ranger/ranger/pkg/apis/project.cattle.io/v3"
	types "github.com/ranger/rke/types"
...
func (in *ClusterSpecBase) DeepCopyInto(out *ClusterSpecBase) {
	*out = *in
	...
	if in.RangerKubernetesEngineConfig != nil {
		in, out := &in.RangerKubernetesEngineConfig, &out.RangerKubernetesEngineConfig
		*out = new(types.RangerKubernetesEngineConfig)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RangerUserNotification) DeepCopyInto(out *RangerUserNotification) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RangerUserNotification.
func (in *RangerUserNotification) DeepCopy() *RangerUserNotification {
	if in == nil {
		return nil
	}
	out := new(RangerUserNotification)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RangerUserNotification) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RangerUserNotificationList) DeepCopyInto(out *RangerUserNotificationList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RangerUserNotification, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RangerUserNotificationList.
func (in *RangerUserNotificationList) DeepCopy() *RangerUserNotificationList {
	if in == nil {
		return nil
	}
	out := new(RangerUserNotificationList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RangerUserNotificationList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
