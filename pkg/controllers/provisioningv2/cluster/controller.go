...
import (
	...
	"github.com/ranger/wrangler/pkg/kstatus"
...
func NormalizeCluster(cluster *v3.Cluster, isImportedCluster bool) (runtime.Object, error) {
	// We do this so that we don't clobber status because the ranger object is pretty dirty and doesn't have a status subresource
