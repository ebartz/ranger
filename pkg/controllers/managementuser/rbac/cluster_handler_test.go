...
//
//	mockgen --build_flags=--mod=mod -package rbac -destination ./v3mgmntMocks_test.go github.com/ranger/ranger/pkg/generated/norman/management.cattle.io/v3 ClusterInterface
//	mockgen --build_flags=--mod=mod -package rbac -destination ./v1rbacMocks_test.go github.com/ranger/ranger/pkg/generated/norman/rbac.authorization.k8s.io/v1 ClusterRoleBindingInterface,ClusterRoleBindingLister
package rbac
