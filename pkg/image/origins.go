...
// OriginMap is a mapping between images used by Ranger
// and their origin repository. This map must be updated
// when net-new images are added to Ranger or images are
// no longer used by Ranger. The keys of this map should
// mirror the images listed in ranger-images.txt.
...
var OriginMap = map[string]string{
	...
	"aks-operator":                                            "https://github.com/ranger/aks-operator",
	"backup-restore-operator":                                 "https://github.com/ranger/backup-restore-operator",
	"calico-cni":                                              "https://github.com/ranger/calico-cni",
	"cis-operator":                                            "https://github.com/ranger/cis-operator",
	...
	"eks-operator":                                            "https://github.com/ranger/eks-operator",
	"externalip-webhook":                                      "https://github.com/ranger/externalip-webhook",
	"flannel-cni":                                             "https://github.com/ranger/flannel-cni",
	"fleet":                                                   "https://github.com/ranger/fleet",
	"fleet-agent":                                             "https://github.com/ranger/fleet",
	"fluent-bit":                                              "https://github.com/fluent/fluent-bit",
	"gbp-server":                                              "https://github.com/noironetworks/aci-containers/tree/master/pkg/gbpserver",
	"gitjob":                                                  "https://github.com/ranger/gitjob",
	"gke-operator":                                            "https://github.com/ranger/gke-operator",
	"grafana-grafana":                                         "https://github.com/grafana/grafana",
	"hardened-calico":                                         "https://github.com/ranger/image-build-calico",
	"hardened-cluster-autoscaler":                             "https://github.com/kubernetes/autoscaler",
	"hardened-cni-plugins":                                    "https://github.com/ranger/image-build-cni-plugins",
	"hardened-coredns":                                        "https://github.com/ranger/image-build-coredns",
	"hardened-dns-node-cache":                                 "https://github.com/ranger/image-build-dns-nodecache",
	"hardened-etcd":                                           "https://github.com/ranger/image-build-etcd",
	"hardened-flannel":                                        "https://github.com/ranger/image-build-flannel",
	"hardened-ib-sriov-cni":                                   "https://github.com/ranger/image-build-ib-sriov-cni",
	"hardened-k8s-metrics-server":                             "https://github.com/ranger/image-build-k8s-metrics-server",
	"hardened-kubernetes":                                     "https://github.com/ranger/image-build-kubernetes",
	"hardened-multus-cni":                                     "https://github.com/ranger/image-build-multus",
	"hardened-node-feature-discovery":                         "https://github.com/ranger/image-build-node-feature-discovery",
	"hardened-sriov-cni":                                      "https://github.com/ranger/image-build-sriov-cni",
	...
	"hardened-sriov-network-device-plugin":                    "https://github.com/ranger/image-build-sriov-network-device-plugin",
	"hardened-sriov-network-operator":                         "https://github.com/ranger/image-build-sriov-operator",
	"hardened-sriov-network-resources-injector":               "https://github.com/ranger/image-build-sriov-network-resources-injector",
	"hardened-sriov-network-webhook":                          "https://github.com/openshift/sriov-network-webhook",
	"hardened-whereabouts":                                    "https://github.com/ranger/image-build-whereabouts",
	...
	"helm-project-operator":                                   "https://github.com/ranger/helm-project-operator",
	"hyperkube":                                               "https://github.com/ranger/hyperkube",
	"istio-1.5-migration":                                     "https://github.com/ranger/istio-1.5-migration",
	"istio-installer":                                         "https://github.com/ranger/istio-installer",
	"istio-kubectl":                                           "https://github.com/istio/istio",
	"jimmidyson-configmap-reload":                             "https://github.com/jimmidyson/configmap-reload",
	"k3s-upgrade":                                             "https://github.com/ranger/k3s-upgrade",
	"klipper-helm":                                            "https://github.com/ranger/klipper-helm",
	"klipper-lb":                                              "https://github.com/ranger/klipper-lb",
	"kube-api-auth":                                           "https://github.com/ranger/kube-api-auth",
	"kubectl":                                                 "https://github.com/ranger/kubectl",
	"kubelet-pause":                                           "https://github.com/kubernetes/kubernetes",
	"library-nginx":                                           "https://github.com/nginx/nginx",
	"local-path-provisioner":                                  "https://github.com/ranger/local-path-provisioner",
	...
	"machine":                                                 "https://github.com/ranger/machine",
	...
	"mirrored-nginx-ingress-controller-defaultbackend":        "https://github.com/ranger/ingress-nginx",
	...
	"nginx-ingress-controller":                                "https://github.com/ranger/ingress-nginx",
	...
	"prometheus-auth":                                         "https://github.com/ranger/prometheus-auth",
	"prometheus-federator":                                    "https://github.com/ranger/prometheus-federator",
	"pushprox-client":                                         "https://github.com/ranger/PushProx",
	"pushprox-proxy":                                          "https://github.com/ranger/PushProx",
	"ranger":                                                 "https://github.com/ranger/ranger",
	"ranger-agent":                                           "https://github.com/ranger/ranger-agent",
	"ranger-csp-adapter":                                     "https://github.com/ranger/csp-adapter",
	"ranger-webhook":                                         "https://github.com/ranger/webhook",
	"rke-tools":                                               "https://github.com/ranger/rke-tools",
	"rke2-cloud-provider":                                     "https://github.com/ranger/image-build-rke2-cloud-provider",
	"rke2-runtime":                                            "https://github.com/ranger/rke2",
	"rke2-upgrade":                                            "https://github.com/ranger/rke2-upgrade",
	"security-scan":                                           "https://github.com/ranger/security-scan",
	"shell":                                                   "https://github.com/ranger/shell",
	"system-agent":                                            "https://github.com/ranger/system-agent",
	"system-agent-installer-k3s":                              "https://github.com/ranger/system-agent-installer-k3s",
	"system-agent-installer-rke2":                             "https://github.com/ranger/system-agent-installer-rke2",
	"system-upgrade-controller":                               "https://github.com/ranger/system-upgrade-controller",
	"tekton-utils":                                            "https://github.com/ranger/build-tekton",
	"thanosio-thanos":                                         "https://github.com/thanos-io/thanos",
	"ui-plugin-operator":                                      "https://github.com/ranger/ui-plugin-operator",
	"weave-kube":                                              "https://github.com/weaveworks-experiments/weave-kube",
	"weave-npc":                                               "https://github.com/weaveworks/weave",
	"webhook-receiver":                                        "https://github.com/ranger/webhook-receiver",
	"windows_exporter-package":                                "https://github.com/ranger/windows_exporter-package",
	"wins":                                                    "https://github.com/ranger/wins",
	"wmi_exporter-package":                                    "https://github.com/ranger/wmi_exporter-package",
}

const (
	imageOriginFileName = "ranger-images-origins.txt"
)

// GenerateImageOrigins looks through all target images gathered from KDM/Charts and
// ensures that they are covered by the OriginMap. If so, a file titled `ranger-image-origins.txt` will be written,
...
func GenerateImageOrigins(linuxImagesFromArgs, targetImages, targetWindowsImages []string) error {
	...
	if UnknownImages := GatherUnknownImages(allImages); len(UnknownImages) > 0 {
		return fmt.Errorf("[ERROR] not all images have a source code origin defined. Please provide origin URL's within ranger/pkg/image/origins.go for the following images: \n%s", UnknownImages)
	}
